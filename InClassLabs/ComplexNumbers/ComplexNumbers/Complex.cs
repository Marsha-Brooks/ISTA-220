...
namespace ComplexNumbers
{
    class Complex
    {
        ...
        public static Complex operator *(Complex lhs, Complex rhs)
        {
            return new Complex(lhs.Real * rhs.Real - lhs.Imaginary * rhs.Imaginary, lhs.Imaginary * rhs.Real
        ...
        public static Complex operator /(Complex lhs, Complex rhs)
        {
            ...
            int imaginaryElement = (lhs.Imaginary * lhs.Real - rhs.Imaginary * rhs.Imaginary);
